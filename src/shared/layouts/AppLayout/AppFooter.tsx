  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t-2 border-gray-200 dark:border-gray-800 py-2">
      <div className="flex items-center justify-center">
        <AppFooterItem href="/profile" title="Profile" isActive={false}>
          <HiUser className="h-full w-6" />
        </AppFooterItem>
        <AppFooterItem href="/rooms" title="Rooms" isActive={true}>
          <HiChatAlt2 className="h-full w-6" />
        </AppFooterItem>
        <AppFooterItem href="/config" title="Config" isActive={false}>
